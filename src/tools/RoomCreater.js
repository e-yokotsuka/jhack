...
const cellName = ['floor_vines0', 'floor_vines1', 'floor_vines2', 'floor_vines3', 'floor_vines4', 'floor_vines5', 'floor_vines6', 'floor_sand_stone0', 'floor_sand_stone1', 'floor_sand_stone2', 'floor_sand_stone3'];
...
const createRoom = (inRect, retry = 0) => {
  ...
  const cell = Math.floor(Math.random() * cellName.length);
  const room = {
    x: inRect.x + addX,
    y: inRect.y + addY,
    width: subWidth - addX,
